...
public final class Common {
    ...
    public final static String ms_warningMessage = "Zorunlu Alanlar Boş Bırakılamaz.";
    ...
    public final static String ms_mainAppPath = System.getenv("ProgramFiles(x86)") + "\\Kismet Oto\\bin\\Kismet-Oto-Stock-Tracking-System-1.0.0.jar";
    public final static String ms_dbStarterAppPath = System.getenv("ProgramFiles(x86)") + "\\Kismet Oto\\bin\\Kismet-Auto-Stock-Tracking-App-Database-Starter-1.0.0.jar";
    public final static String ms_logoPath = System.getenv("ProgramFiles(x86)") + "\\Kismet Oto\\assets\\default_logo.png";
